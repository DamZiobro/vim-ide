...
let s:bwc.deepergravel   = ['35322d', 160]
let s:bwc.darkgravel     = ['242321', 235]
let s:bwc.blackgravel    = ['1c1b1a', 233]
let s:bwc.blackestgravel = ['141413', 232]

let s:bwc.deepred     = ['', 124]
let s:bwc.deepgreen   = ['', 22]
let s:bwc.deepyellow  = ['', 100]
let s:bwc.deepblue    = ['', 18]
...
call HL('DiffDelete', '', 'deepred')
call HL('DiffAdd',    '',     'deepgreen')
call HL('DiffChange', '',     'deepyellow')
call HL('DiffText',   'snow', 'deepblue', 'bold')
